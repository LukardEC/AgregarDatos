...
import com.ug.agregardatos.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.heroImage.setOnClickListener(view -> { openCamara();
        });
    }
    ...
    private void OpenDetailActivity(String superheroName,String alertEgo,String bio,float rating){
